export const Introduction = ({ time }: { time: string }) => {
    return (
        <section className="m-auto min-h-[160vh] md:min-h-screen px-6 pt-24 sm:px-14 sm:pt-28 md:px-16" id="introduction">
            ...
            <div className="font-light font-lato flex flex-wrap gap-10 text-xl md:flex-nowrap md:gap-18 lg:gap-12 lg:text-2xl leading-loose *:text-justify">
                <p>
                    ...
                    Bekasi, Jawa Barat. Saat ini saya kuliah di Universitas Negeri Jakarta dengan Program Studi Administrasi Perkantoran Digital (D4) Fakultas Ekonomi.
                    Saya tertarik dan sedang mempelajari bahasa C++ dan hal-hal yang berkaitan dengan arduino.
                </p>
                <p>
