      ...
      <div className="flex one two-1200">
        <div>
          <p className={styles.text}>
            ...
            Ezra. Saat ini saya berumur 15 tahun. Saya tinggal dan tinggal di
            Bekasi, Jawa Barat. Masih duduk dibangku sekolah SMA, bersekolah di
            SMA Negeri 12 Kota Bekasi kelas X Bahasa. Sekarang sedang
            mempelajari bahasa C++ dan hal-hal yang berkaitan dengan arduino.
          </p>
        </div>
        <div>
          <p className={styles.text}>
            ...
            melakukan development web menggunakan JavaScript, Node.js, dan
            React.
          </p>
        </div>
      </div>
